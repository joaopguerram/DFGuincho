  ...
  return (
    <section className="sectionAbout">
      ...
      <p>
        ...
        Somos uma equipe de especialistas em serviços de guinchos, auto socorro
        e resgastes dedicados a garantir que você esteja sempre seguro e em
        movimento, não importa a situação. Com uma equipe experiente, estamos
        prontos para atender a todas as suas necessidades de guincho, auto
